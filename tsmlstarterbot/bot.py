...
class Bot:
            ...
            for player in game_map.all_players():
                for ship in player.all_ships():
                    ...
                    if player == game_map.get_me():
                        ...
                        #Seems like gravity is a function of ships health/distance
                        #I cubed it (vs sqaured) to make the distance have a greater effect on sending a ship to a planet
                        #Trying to stop ships from changing course
                        #this was no help so I put it back
                        gravity += ship.health / (d * d)
                    else:
    ...
    def navigate(self, game_map, start_of_round, ship, destination, speed):
        ...
        have_time = current_time - start_of_round < .9
